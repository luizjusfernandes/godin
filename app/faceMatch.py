...
def get_graph(img):
    """Requests you to annotate an image. Returns a combined image (original and anottated) and a graph object"""
    global ix, iy, drawing, mask, n, mode, cropped, circle_size, G
    drawing = False
    ix,iy = -1,-1
    mode = False #change to 1 if cropping
    def draw_polygon(event, x, y, flags, img):
        global ix, iy, drawing, mask, n, mode, cropped, circle_size, G
